...
class OperatorUpdateCookie : public OperatorCookies
{
public:
  OperatorUpdateCookie() { TSDebug(PLUGIN_NAME_DBG, "Calling CTOR for OperatorUpdateCookie"); }
  void initialize(Parser &p);
...
private:
  DISALLOW_COPY_AND_ASSIGN(OperatorUpdateCookie);
...
{
enum CookieOp { COOKIE_OP_DEL, COOKIE_OP_ADD, COOKIE_OP_UPD };
